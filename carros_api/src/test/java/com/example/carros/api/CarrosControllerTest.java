...
import com.example.carros.CarrosApplication;
...
public class CarrosControllerTest {
    ...
    public void testSave() {
        ...
        carro.setUrlFoto("https://teste.com.br");
        carro.setUrlVideo("https://teste.com.br");
        carro.setLatitude("teste");
        carro.setLongitude("teste");
        ...
        assertEquals("Teste", c.getDescricao());
        assertEquals("https://teste.com.br", c.getUrlFoto());
        assertEquals("https://teste.com.br", c.getUrlVideo());
        assertEquals("teste", c.getLatitude());
        assertEquals("teste", c.getLongitude());
